      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start flex-grow">
        ...
        <div className="lg:col-span-7 space-y-6">
          {!activeSession ? (
            ...
            <div className="flex flex-col items-center text-center p-6 border border-[#7D53F6]/20 bg-[#7D53F6]/5 rounded-3xl relative overflow-hidden shadow-sm">
        ...
        <div className="lg:col-span-5 space-y-4 border border-slate-100 rounded-3xl p-5 bg-slate-50/30">
          <div className="flex justify-between items-center pb-2 border-b border-slate-100">
            <h4 className="font-bold text-slate-800 text-sm flex items-center gap-1.5">
              <UserCheck size={16} className="text-emerald-500" />
              Scans Received
            </h4>
            <span className="bg-emerald-50 text-emerald-600 text-[10px] font-black px-2.5 py-0.5 border border-emerald-100 rounded-full flex items-center gap-1">
              {activeSession && <RefreshCw size={8} className="animate-spin" />} {scannedStudents.length} logged
            </span>
          </div>
          ...
          <div className="space-y-2 max-h-[380px] overflow-y-auto pr-1">
            {!activeSession ? (
              <div className="text-center py-20 text-slate-400 text-xs">
                ...
                <p className="text-[10px] font-bold text-slate-400/80 uppercase tracking-wider mt-1">
                  Select hour and generate code to start.
                </p>
              </div>
              ...
              scannedStudents.map((log) => (
                <div
                  key={log.id}
                  className="flex items-center gap-2.5 p-2.5 bg-white border border-slate-100/80 rounded-xl animate-slideIn shadow-sm"
                >
